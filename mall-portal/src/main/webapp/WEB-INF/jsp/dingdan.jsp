...
<link rel="shortcut icon" type="image/x-icon"
	href="${ctx}/static/yungou/img/icon/favicon.ico">
<link rel="stylesheet" type="text/css"
	href="${ctx}/static/yungou/css/base.css">
<link rel="stylesheet" type="text/css"
	href="${ctx}/static/yungou/css/home.css">
<link rel="stylesheet" type="text/css"
	href="${ctx}/static/yungou/css/member.css">
<script type="text/javascript" src="${ctx}/static/yungou/js/jquery.js"></script>
<script type="text/javascript" src="${ctx}/static/yungou/js/index.js"></script>
<script type="text/javascript"
	src="${ctx}/static/yungou/js/modernizr-custom-v2.7.1.min.js"></script>
<script type="text/javascript"
	src="${ctx}/static/yungou/js/jquery.SuperSlide.js"></script>
<script type="text/javascript">
	...
	<header id="pc-header">
		...
		<div class="pc-header-logo clearfix">
			...
			<div class="fr pc-head-car">
				<i class="icon-car"></i> <a href="#">我的购物车</a> <em>10</em>
			</div>
		</div>
		<!--  顶部    start-->
		<div class="yHeader">
				...
				<div class="member-border">
					<div class="member-return H-over">
						<div class="member-cancel clearfix">
							<span class="be1">订单信息</span> <span class="be2">收货人</span> <span
								class="be2">订单金额</span> <span class="be2">订单时间</span> <span
								class="be2">订单状态</span> <span class="be2">订单操作</span>
						</div>
									...
									<li>
										...
										<div class="member-circle clearfix">
												...
												<c:forEach items="${orderItemList}" var="orderItem">
													<c:if test="${order.orderNo==orderItem.orderNo}">
														<div class="ci7 clearfix">
															<span class="gr1">
																<a href="#">
																	<img src="images/shangpinxiangqing/X-1.png" title="" about="" width="60" height="60">
																</a>
															</span> 
															<span class="gr2">
											...
											<div class="ci5 ci8">
												...
												<p></p>
												<p>
													<a href="#" class="member-touch">确认收货</a>
												</p>
											</div>
										</div>
